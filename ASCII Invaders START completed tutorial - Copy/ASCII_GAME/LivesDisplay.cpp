...
CHAR_INFO LivesDigitSprite[NUM_DIGITS][DIGIT_WIDTH * DIGIT_HEIGHT] =
{
	{
...
{
	AnimatedSprite::Initialise(&LivesDigitSprite[0][0], Vector3(DIGIT_WIDTH, DIGIT_HEIGHT, NUM_DIGITS));
